...
### Method A: Using XAMPP Shell / CMD
Open XAMPP Control Panel → click **Shell** (or open Terminal) and run:

```cmd
mysql -u root < "c:\Users\vivo9\Downloads\Dit shop\database\schema.sql"
```
...
This creates the `ditshop` database, all tables, and seeds your default admin account:
